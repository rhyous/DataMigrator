...
public partial class Aamessage
{
    public int IKeyId { get; set; }

    public int IKeyLanguage { get; set; }

    public string CMessageKey { get; set; }

    public string CMessageText { get; set; }

    public bool BFlagDialogText { get; set; }
    ...
    public virtual Aalanguage IKeyLanguageNavigation { get; set; }
}