...
public partial class AaperspectiveCode
{
    public int IKeyId { get; set; }

    public int IKeyCode { get; set; }

    public int IKeyPerspective { get; set; }
    ...
    public virtual Aacode IKeyCodeNavigation { get; set; }

    public virtual Aaperspective IKeyPerspectiveNavigation { get; set; }
}