...
public partial class AanvstSale
{
    public int IKeyId { get; set; }

    public int IKeyTrans { get; set; }

    public bool BFlagSharesValidated { get; set; }

    public bool BFlagBasisValidated { get; set; }
    ...
    public virtual ICollection<AanvstTaxLot> AanvstTaxLots { get; set; } = new List<AanvstTaxLot>();
}